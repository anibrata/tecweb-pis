...
public class BuildInvertedIndexCompressed extends Configured implements Tool 
{
	...
	private static class MyMapper extends Mapper<LongWritable, Text, PairOfStringInt, IntWritable>
	{
		...
		public void map(LongWritable docno, Text doc, Context context) throws IOException, InterruptedException 
		{
			...
			StringTokenizer itr = new StringTokenizer(text); // Tokenize the text as lines/ Every line represents a document
	...
	private static class MyReducer extends Reducer<PairOfStringInt, IntWritable, Text, PairOfWritables<VIntWritable, BytesWritable>> 
	{
